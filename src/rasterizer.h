...
namespace CGL {
  ...
  public:
    ...
    bool p_in_triangle(float x, float y,
      float x0, float y0, 
      float x1, float y1, 
      float x2, float y2);
    // Rasterize a triangle
    ...
    // P1 = (x1, y1)
    // P2 = (x2, y2)
    void super_sample_rasterization(float x, float y,
      float x0, float y0,
      float x1, float y1,
      float x2, float y2,
      Color color);
    
    void rasterize_flat_triangle(float x0, float y0,
      float x1, float y1,
      float x2, float y2,
      Color color); 
